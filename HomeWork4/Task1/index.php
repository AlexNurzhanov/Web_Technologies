...
$works = [
  [
    ...
    "deskription" => "Тут описание работы разработчиком тут описание работы
  ...
  [
    ...
    "dateEnd" => "Январь 2015",
    "deskription" => "Тут описание работы дворником тут описание работы
  ...
  [
    ...
    "dateEnd" => "Январь 2010",
    "deskription" => "Тут описание работы главбуха в газпроме",
  ],
];
?>
<!DOCTYPE html>
